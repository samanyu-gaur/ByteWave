...
export default function SkillMap() {
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/progress/1`)
      ...
      .then(d => {
        setNodes(d)
        // Auto-select first in-progress topic
        const first = d.find(n => n.status === 'In progress') || d[0]
      ...
      {loading ? <SkillMapSkeleton /> : (
        <>
          ...
          <div style={{
            ...
            flexWrap: 'wrap',
            /* grow to fill the available viewport height */
            minHeight: 'calc(100vh - 280px)',
          }}>
            {/* Constellation (fills remaining width + all available height) */}
